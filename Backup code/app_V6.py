    ...
    with gr.Blocks(title="EMMA") as demo:
        ...
        def handle_login_check(name, state):
            ...
            if name in memory:
                ...
                # در handle_login_check و handle_register اضافه کنید:
                print(f"[DEBUG] Login/Register for {name}")
                print(f"[DEBUG] sessions_memory: {sessions_memory}")
                print(f"[DEBUG] semantic_memory: {semantic_memory}")
