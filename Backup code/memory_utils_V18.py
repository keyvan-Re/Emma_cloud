...
# خواندن مسیر دیسک دائمی از متغیر محیطی (مشابه app.py)
BASE_DATA_DIR = os.getenv("EMMA_DATA_DIR", os.path.join(PROJECT_ROOT, "data"))

# مسیر فایل مموری
MEMORY_FILE_PATH = os.path.join(BASE_DATA_DIR, "memories", "update_memory_0512_eng.json")

# مسیر فایل‌های ایندکس (LlamaIndex)
